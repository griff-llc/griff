...
<head>
	...
	<title>Suburb | Homepage V1</title>
	...
	<div id="page-content_home">
		<div class="home_2">
			<div id="owl-demo-header" class="owl-carousel owl-theme carousel-full-width">
				<div class="item">
					...
					<div class="head-title-2" style="background: url('assets/img/header_image_2.jpg') center;background-size: cover;">
						<div class="container">
				...
				<div class="item">
					<span class="filter"></span>
					<div class="head-title-2" style="background: url('assets/img/header_image.jpg') center;background-size: cover;">
						<div class="container">
							<div class="title col-lg-6 col-lg-offset-0 col-md-6 col-sm-8 col-sm-offset-1 col-xs-9 col-xs-offset-1">
								<h1>The simplest way <br> to find the right Property</h1>
								<h4>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it</h4>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<a href="search_result.html" class="exp-img" style="background:url('./assets/img/home_1.jpg') center;background-size: cover;">
						<span class="filter"></span>
						<div class="img-info">
				...
				<div class="col-md-4 col-sm-6">
					<a href="search_result.html" class="exp-img" style="background:url('./assets/img/home_2.jpg') center;background-size: cover;">
						<span class="filter"></span>
						<div class="img-info">
							<h3>1+ Bedroom Apt</h3>
							<h6>33 Properties</h6>
				...
				<div class="col-md-4 col-sm-6">
					<a href="search_result.html" class="exp-img" style="background:url('./assets/img/home_3.jpg') center;background-size: cover;">
						<span class="filter"></span>
						<div class="img-info">
							<h3>Cozy Houses</h3>
							<h6>33 Properties</h6>
				...
				<div class="col-md-4 col-sm-6">
					<a href="search_result.html" class="exp-img" style="background:url('./assets/img/home_4.jpg') center;background-size: cover;">
						<span class="filter"></span>
						<div class="img-info">
							<h3>Luxury House</h3>
							<h6>33 Properties</h6>
				...
				<div class="col-md-8">
					<a href="search_result.html" class="exp-img" style="background:url('./assets/img/home_5.jpg') center;background-size: cover;">
						<span class="filter"></span>
						<div class="img-info">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-3 col-sm-3 col-xs-6 prop">
						<div class="wht-cont">
							<div class="exp-img-2" style="background:url('assets/img/shortcodes-header.jpg') center;background-size: cover;">
								<span class="filter"></span>
					...
					<div class="col-md-3 col-sm-3 col-xs-6 prop">
						<div class="wht-cont">
							<div class="exp-img-2" style="background:url('assets/img/home_7.jpg') center;background-size: cover;">
								<span class="filter"></span>
								<span class="ffs-bs"><label for="op" class="btn btn-small btn-primary">browse photos</label></span>
								<div class="overlay">
									<div class="img-counter">23 Photo</div>
					...
					<div class="col-md-3 col-sm-3 col-xs-6 prop">
						<div class="wht-cont">
							<div class="exp-img-2" style="background:url('assets/img/home_8.jpg') center;background-size: cover;">
								<span class="filter"></span>
								<span class="ffs-bs"><label for="op" class="btn btn-small btn-primary">browse photos</label></span>
								<div class="overlay">
									<div class="img-counter">23 Photo</div>
					...
					<div class="col-md-3 col-sm-3 col-xs-6 prop">
						<div class="wht-cont">
							<div class="exp-img-2" style="background:url('assets/img/home_9.jpg') center;background-size: cover;">
								<span class="filter"></span>
								<span class="ffs-bs"><label for="op" class="btn btn-small btn-primary">browse photos</label></span>
								<div class="overlay">
									<div class="img-counter">23 Photo</div>
		...
		<div class="wide-3 carousel-full-width">
			...
			<div id="owl-demo" class="owl-carousel owl-theme ">
				<div class="item">
					<div class="image" style="background:url('assets/img/sara-1.png') center"></div>
					<div class="img-info">
						<div class="row">
				...
				<div class="item">
					<div class="image" style="background:url('assets/img/sara-2.png') center"></div>
					<div class="img-info">
						<div class="row">
							<div class="half col-xs-7">
				...
				<div class="item">
					<div class="image" style="background:url('assets/img/sara-3.png') center"></div>
					<div class="img-info">
						<div class="row">
							<div class="half col-xs-7">
				...
				<div class="item">
					<div class="image" style="background:url('assets/img/sara-4.png') center"></div>
					<div class="img-info">
						<div class="row">
							<div class="half col-xs-7">
				...
				<div class="item">
					<div class="image" style="background:url('assets/img/sara-5.png') center"></div>
					<div class="img-info">
						<div class="row">
							<div class="half col-xs-7">
			...
			<section class="block testimonials">
				...
				<div class="owl-carousel testimonials-carousel">
					<blockquote class="item">
						...
						<figure>
							<div class="image">
								<img src="{{asset('assets/img/sara-3.png')}}" alt="">
							</div>
							<p>Johan Nordquist</p>
					...
					<blockquote class="item">
						...
						<figure>
							<div class="image">
								<img src="{{asset('assets/img/sara-4.png')}}" alt="">
							</div>
							<p>Sara Genergy</p>
							<p class="team-color">Someone From Company</p>
						</figure>
					...
					<blockquote class="item">
						...
						<figure>
							<div class="image">
								<img src="{{asset('assets/img/sara-5.png')}}" alt="">
							</div>
							<p>Sara Strawberry</p>
							<p class="team-color">Someone From Company</p>
						</figure>
		...
		<div class="wide-3">
			<div class="container">
				<div class="logo-cont">
					<div class="logos" style="background:url('assets/img/brand_1.png') center no-repeat"></div>
				</div>
				<div class="logo-cont">
					<div class="logos" style="background:url('assets/img/brand_2.png') center no-repeat"></div>
				</div>
				<div class="logo-cont">
					<div class="logos" style="background:url('assets/img/brand_3.png') center no-repeat"></div>
				</div>
				<div class="logo-cont">
					<div class="logos" style="background:url('assets/img/brand_4.png') center no-repeat"></div>
				</div>
				<div class="logo-cont">
					<div class="logos" style="background:url('assets/img/brand_5.png') center no-repeat"></div>
				</div>
			</div>
		</div>
		<!-- end wide-3 -->
	...
	<div class="overlay overlay-hugeinc">
		...
		<nav>
			...
			<div class="owl-carousel owl-theme carousel-full-width owl-demo-3">
				<div class="item" style="background-image: url('assets/img/recent.jpg'); width: 800px; height: 650px"></div>
				<div class="item" style="background-image: url('assets/img/recent.jpg');"></div>
			</div>
			<!-- End Owl carousel -->
		</nav>
	</div>
...
<script>
    ...
    function join() {
	    ...
	    var password = $("#joinPass").val();
	    var confirm = $("#joinConfirm").val();
